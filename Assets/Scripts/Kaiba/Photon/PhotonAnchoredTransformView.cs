...
public class PhotonAnchoredTransformView : MonoBehaviourPun, IPunObservable
{
    ...
    public void Update()
    {
        ...
        if (!this.photonView.IsMine)
        {
            ...
            tr.rotation = Quaternion.RotateTowards(tr.rotation, m_NetworkAnchoredRotation * Quaternion.Euler(0, 180, 0), this.m_Angle * (1.0f / PhotonNetwork.SerializationRate));
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            if (this.m_SynchronizeRotation)
            {
                ...
                m_NetworkAnchoredRotation = anchor.transform.localRotation * m_NetworkRotation;
